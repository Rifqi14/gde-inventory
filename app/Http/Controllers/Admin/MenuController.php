...
class MenuController extends Controller
{
    ...
    /**
     * To create dropdown list contain menu data from menus table
     *
    ...
    public function index(){
        $query = Menu::select('menus.id','menus.parent_id','menus.menu_name as description','menus.menu_route as url')
