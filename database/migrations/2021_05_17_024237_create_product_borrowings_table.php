...
class CreateProductBorrowingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_borrowings', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('borrowing_number')->nullable();
    ...
    {
        Schema::dropIfExists('product_borrowings');
    }
}