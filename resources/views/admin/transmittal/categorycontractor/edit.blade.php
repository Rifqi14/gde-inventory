...
<section class="content" id="content">
  <div class="container-fluid">
    <form action="{{ route('transmittalproperties.categorycontractor.update', ['id' => $data->id]) }}" method="post" id="form-categorycontractor" autocomplete="off" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-sm-5">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9 p-0">
                  <input type="text" name="address" id="address" class="form-control" placeholder="Please insert address..." value="{{ $data->address }}">
                </div>
              </div>
              <div class="form-group row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="upload-btn-wrapper">
                          ...
                          <input class="form-control" type="file" name="app_logo" id="app_logo" accept="image/*" value="{{ $data->logo }}" />
                        </div>
