          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6 controls">
                <input type="text" class="form-control" name="code" placeholder="Code..." value="{{ $calendar->code }}" />
              </div>
            </div>
            <div class="form-group row">
              <label class="col-md-2 col-xs-12 control-label" for="name">Name: <b class="text-danger">*</b></label>
              <div class="col-sm-6 controls">
                <input type="text" class="form-control" name="name" placeholder="Name..." value="{{ $calendar->name }}" />
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-6 controls">
                <div class="icheck-primary">
                  <input type="checkbox" name="is_default" id="is_default" @if ($calendar->is_default == 'YES') checked @endif>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6 controls">
                <textarea class="form-control" name="description" rows="4" style="resize: none;" placeholder="Description...">{!! $calendar->description !!}</textarea>
              </div>
            </div>
          </div>
