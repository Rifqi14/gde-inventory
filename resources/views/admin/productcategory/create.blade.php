...
<div class="row mb-3 mt-3">
  <div class="col-sm-4">
    <h1 id="title-branch" class="m-0 text-dark">
      {{ $menu_name ? $menu_name : 'Product Category' }}
    </h1>
  </div>
  <div class="col-sm-8">
          ...
          <form class="form-horizontal no-margin" action="{{$url}}" id="form" method="post">
            <div class="card-body">
              ...
              <div class="form-grup row mt-4">
                ...
                <div class="col-md-6 controls">
                  <input class="form-control" type="text" id="category-name" name="name" placeholder="Category Name" required>
                </div>
              </div>
              <div class="form-group row mt-4">
...
@section('scripts')
<script src="{{asset('assets/js/jquery/jquery.gritter.min.js')}}"></script>
<script>
  toastr.options = {
                    "closeButton": false,
                    "debug": false,
