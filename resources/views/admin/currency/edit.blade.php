...
<section class="content" id="content">
  <div class="container-fluid">
    <form action="{{ route('currency.update', ['id' => $currency->id]) }}" role="form" method="POST" enctype="multipart/form-data" autocomplete="off" id="form">
      @csrf
      @method('PUT')
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="symbol" class="form-control" value="{{ $currency->symbol }}" placeholder="e.g: $ / Rp">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label" for="code">Code</label>
                    <input type="text" name="code" class="form-control" value="{{ $currency->code }}" placeholder="e.g: USD / IDR" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label" for="currency">Currency</label>
                    <input type="text" name="currency" class="form-control" placeholder="e.g: Dollar / Rupiah" value="{{ $currency->currency }}" required>
                  </div>
                </div>
                <div class="col-md-6">
...
<script>
  ...
  $(function(){
    ...
    @if ($currency->country)
      $('#countries_id').select2('trigger', 'select', {
        data: {id: `{{ $currency->country->id }}`, text: `{{ $currency->country->country }}`}
      });
    @endif
