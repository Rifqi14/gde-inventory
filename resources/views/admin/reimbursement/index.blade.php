      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title mt-2"> List of Reimbursement Request</h3>
            <div class="text-right">
              ...
              <button type="button" id="add-business-trip" class="btn btn-labeled text-sm btn-sm btn-success btn-flat legitRipple float-right ml-1" onclick="windowLocation('{{route('reimbursement.create')}}')">
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-striped" id="table-bt-general">
              <thead>
                <tr>
                  <th width="5%">No.</th>
                  <th width="20%">Reimbursement Number</th>
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"> List of Reimbursement Declaration</h3>
            <div class="text-right">
              @if(in_array('read',$actionmenu))
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Reimbursement Filter</h5>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label" for="business-trip-number">Reimbursement Number</label>
                  <input class="form-control business-trip-number" type="text" name="business_trip_number" id="business-trip-number" placeholder="Reimbursement Number">
                </div>
