...
<section class="content" id="content">
  <div class="container-fluid">
    <form action="{{ route('uom.store') }}" role="form" method="POST" enctype="multipart/form-data" autocomplete="off" id="form">
      @csrf
      <div class="card">
        <div class="card-body">
          <span class="title">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="text" name="ratio" id="ratio" value="1" readonly class="form-control" placeholder="Ratio">
              </div>
            </div>
          </div>
        </div>
