...
<section class="content" id="content">
  <div class="container-fluid">
    <form action="{{ route('organization.update', ['id' => $organization->id]) }}" method="post" role="form" enctype="multipart/form-data" autocomplete="off" id="form">
      @csrf
      @method('PUT')
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group row">
                ...
                <input type="text" name="code" id="code" class="form-control col-md-8" placeholder="Code" value="{{ $organization->code }}">
              </div>
            </div>
            <div class="col-md-8">
              <div class="form-group row">
                <label for="name" class="control-label col-md-3">Name</label>
                <input type="text" name="name" id="name" class="form-control col-md-8" placeholder="Name" value="{{ $organization->name }}">
              </div>
            </div>
          </div>
        </div>
