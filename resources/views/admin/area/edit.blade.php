...
<section class="content" id="content">
  <div class="container-fluid">
    <form action="{{ route('area.update', ['id' => $area->id]) }}" method="post" role="form" enctype="multipart/form-data" autocomplete="off" id="form">
      @csrf
      @method('PUT')
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group row">
                ...
                <select name="site_id" id="site_id" class="form-control select col-md-8"></select>
              </div>
            </div>
            <div class="col-md-8">
              <div class="form-group row">
                <label for="area" class="control-label col-md-3">Area Name</label>
                <input type="text" name="area" id="area" class="form-control col-md-8" value="{{ $area->name }}">
              </div>
            </div>
            <div class="col-md-8">
              <div class="form-group row">
                <label for="remark" class="control-label col-md-3">Remark</label>
                <textarea class="form-control summernote col-md-8 d-none" name="remark" id="remark" rows="4" placeholder="Remark...">{{ $area->remark }}</textarea>
              </div>
            </div>
          </div>
        </div>
