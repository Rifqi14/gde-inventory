                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote summernote1" name="description" rows="4" placeholder="Enter description" >{{ $data->description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mt-4">
                                <label for="attach">Attachment:</label>
                                @if($data->attach_report)
                                <a href="{{ ($data->attach_report)?url($data->attach_report):"" }}" download target="_blank" >
                                    <div class="text-md text-info text-bold">
                                        Download
                                    </div>
                                </a>
                            ...
                            <div class="form-group">
                                <div class="icheck-success d-inline ml-2">
                                    <input type="checkbox" value="finance" name="finance" id="finance0" {{ ($data->finance)?'checked':'' }} disabled  >
                            ...
                            <div id="wbs" class="form-group" style="display: none;">
                                ...
                                <div id="form-budget">
                                    ...
                                    <div class="row item-budget {{ ($num>1)?'mt-1':'' }}" {{ ($num>1)?'id="rbudget-'.$num.'"':'' }} >
                                        <div class="col-md-7">
                                            <select type="text" class="select2 form-control" name="budget_id[]" data-placeholder="Enter budget..." disabled >
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="budget_val[]" class="form-control input-price text-right" placeholder="Enter value" value="{{ number_format($bud->value,'2',',','.') }}" readonly>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="text-right mb-1">
                        ...
                        @if($cek_spv == $data->spv_id)
                            ...
                            <button type="button" onclick="onApproved('approved')" class="btn btn-success btn-labeled legitRipple text-sm" id="btn-submit">
                                <b><i class="fas fa-check-circle"></i></b>
                                Approved
                            </button>
                            @endif
                        @endif
                        @if($data->status == 'approved' or $data->status == 'revise')
                            <a href="{{ route('grievance.index')."/?type=report" }}" class="btn bg-maroon color-palette btn-labeled legitRipple text-sm" >
                            <b><i class="fas fa-arrow-left"></i></b>
                            Back
                            </a>
                        @else
                            <a href="{{ route('grievance.index')."/?type=report" }}" class="btn bg-maroon color-palette legitRipple text-sm" >
                            <b><i class="fas fa-arrow-left"></i></b>
                            </a>
                        @endif
                    </div>
...
$('#form-data-edit').submit(function (e) {
    e.preventDefault();
    $.ajax({
        url: '{{ route("grievance.report.update_status") }}',
        method: 'post',
