...
<section class="content" id="content">
  <div class="container-fluid">
    <form action="{{ route('equipment.update', ['id' => $equipment->id]) }}" method="post" role="form" enctype="multipart/form-data" autocomplete="off" id="form">
      @csrf
      @method('PUT')
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="form-group row">
                ...
                <input type="text" name="equipment_name" id="equipment_name" class="form-control col-md-8" placeholder="Asset Name" value="{{ $equipment->equipment_name }}">
              </div>
            </div>
            <div class="col-md-8">
              <div class="form-group row">
                <label for="remark" class="control-label col-md-3">Remark</label>
                <textarea class="form-control summernote col-md-8 d-none" name="remark" id="remark" rows="4" placeholder="Remark...">{{ $equipment->remark }}</textarea>
              </div>
            </div>
          </div>
        </div>
...
@section('scripts')
<script>
  var data  = @json(json_decode($equipment));
  toastr.options = {
                    "closeButton": false,
                    "debug": false,
                    "newestOnTop": false,
