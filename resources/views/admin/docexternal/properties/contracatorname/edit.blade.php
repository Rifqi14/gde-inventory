...
<section class="content" id="content">
  <div class="container-fluid">
    <form action="{{ route('contractorname.update', ['id' => $contractorname->id]) }}" method="post" role="form" enctype="multipart/form-data" autocomplete="off" id="form">
      @csrf
      @method('PUT')
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="form-group row">
                ...
                <input type="text" name="name" id="name" class="form-control col-md-8" placeholder="Name" value="{{ $contractorname->name }}">
              </div>
            </div>
          </div>
        </div>
  ...
  $(function() {
    ...
    @if ($contractorname->role)
      $('#role_id').select2('trigger', 'select', {
        data: {
          id: `{{ $contractorname->role->id }}`,
          text: `{{ $contractorname->role->name }}`,
        }
      });
    @endif
  });
