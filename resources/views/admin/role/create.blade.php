...
<section class="content" id="content">
    <div class="container-fluid">
        <form id="form" role="form" action="{{route('role.store')}}" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row mt-5">
                                ...
                                <div class="col-sm-6 controls">
                                    <input type="text" class="form-control" id="code" name="code" placeholder="Name" required="" aria-required="true">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Display Name" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <div class="icheck-primary">
                                        <input type="checkbox" name="data_manager" id="data_manager">
