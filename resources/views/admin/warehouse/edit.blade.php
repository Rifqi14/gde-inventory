                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label class="col-md-12 col-xs-12 control-label" for="village_id">Sub Distric <b style="color: red;">*</b></label>
                                        <div class="col-sm-12 controls">
                                            <select data-placeholder="Choose Distric" style="width: 100%;" required class="select2 form-control" id="village_id" name="subdistrict_id" data-placeholder="Select Distric">
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(function() {
        ...
        $("#site_id").select2("trigger", "select", {
            data: {
                id: '{{$warehouse->site_id}}',
                text: '{{$warehouse->site->name}}'
            }
        });
        ...
        $("#province_id").select2("trigger", "select", {
            data: {
                id: '{{$warehouse->province_id}}',
                text: '{{$warehouse->province->name}}'
            }
        });
        ...
        $("#region_id").select2("trigger", "select", {
            data: {
                id: '{{$warehouse->region_id}}',
                text: '{{$warehouse->region->name}}'
            }
        });
        ...
        $("#village_id").select2("trigger", "select", {
            data: {
                id: '{{$warehouse->subdistrict_id}}',
                text: '{{$warehouse->village->name}}'
            }
        });
    });
</script>
