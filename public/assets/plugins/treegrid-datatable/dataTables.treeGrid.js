...
(function (factory) {
    ...
    var TreeGrid = function (dt, init) {
        ...
        if (!(this instanceof TreeGrid)) {
            alert(
                'TreeGrid warning: TreeGrid must be initialised with the "new" keyword.'
            );
            return;
        }
        ...
        fnConstruct: function (oInit) {
            ...
            var resetTreeGridRows = function (trId) {
                ...
                if (subRows && subRows.length) {
                    ...
                    $("#" + trId)
                        .find(".treegrid-control-open")
                        .each(function (i, td) {
                            $(td)
                                .removeClass("treegrid-control-open")
                                .addClass("treegrid-control");
            ...
            dataTable.on("click", "td.treegrid-control", function (e) {
                ...
                var layer =
                    parseInt(td.find("span").css("margin-left") || 0, 10) /
                    sLeft;
                var icon = collapseIcon.clone();
                icon.css("marginLeft", layer * sLeft + "px");
                td.removeClass("treegrid-control").addClass(
                ...
                if (data.children) {
                    ...
                    data.children.forEach(function (item) {
                        ...
                        treegridTd
                            .next()
                            .css("paddingLeft", paddingLeft + left + "px");
            ...
            dataTable.on("click", "td.treegrid-control-open", function (e) {
                ...
                icon.css("marginLeft", layer * sLeft + "px");
                td.removeClass("treegrid-control-open").addClass(
                    "treegrid-control"
                );
                td.html("").append(icon);
    ...
    function selectParent(dataTable, index) {
        ...
        if (parentIndex !== null) {
            ...
            var selectedChildRows = dataTable
                .rows(selector, { selected: true })
                .nodes();
    ...
    function selectChildren(dataTable, index) {
        var rows = dataTable.rows('[parent-index="' + index + '"]', {
            selected: false,
        });
